...
window.LANG_KO = {
  ...
  "syncCreator": {
    ...
    "splitHere": "여기서 나누기",
    "multiVocalMetaRequired": "여러 보컬 모드에서는 현재 보컬의 SPEAKER와 TYPE을 먼저 선택해야 합니다.",
    ...
    "linePartMetaRequired": "{line}번째 줄의 모든 보컬 파트에 SPEAKER와 TYPE을 선택해야 합니다.",
    "lineMetaRequired": "{line}번째 줄의 SPEAKER와 TYPE을 선택해야 합니다.",
    "multiVocalBannerParts": "여러 보컬 모드: 각 보컬 파트를 따로 싱크하세요.",
    "multiVocalBannerLine": "여러 보컬 모드: 이 줄의 SPEAKER와 TYPE을 선택하세요.",
