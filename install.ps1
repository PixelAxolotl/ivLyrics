...
Write-Step 1 8 "Checking network connectivity..." "running"
...
Write-Step 2 8 "Checking Spicetify installation..." "running"
...
Write-Step 3 8 "Checking Spotify process..." "running"
...
Write-Step 4 8 "Checking target directory..." "running"
...
Write-Step 5 8 "Fetching latest version..." "running"
...
try {
    ...
    try {
        ...
        Write-Step 5 8 "Failed to fetch version info" "error"
...
Write-Step 6 8 "Downloading ivLyrics..." "running"
...
try {
    ...
    Write-Step 6 8 "Download failed after $MAX_RETRIES attempts" "error"
...
# Step 7: Update Addon Manager
Write-Section "CONFIGURING"
Write-Step 7 8 "Updating Addon Manager..." "running"

$ADDON_MANAGER_URL = "https://ivlis.kr/ivLyrics/addon-manager.ps1"
$FINAL_APP_DIR = Join-Path $TARGET_DIR $FINAL_APP_NAME
$DEST_SCRIPT = Join-Path $FINAL_APP_DIR "addon-manager.ps1"

Write-SubStep "Downloading Addon Manager..." "info"
try {
    Invoke-WebRequest -Uri $ADDON_MANAGER_URL -OutFile $DEST_SCRIPT -UseBasicParsing -ErrorAction Stop

    Write-SubStep "Executing update..." "info"
    # Execute addon-manager update
    & $DEST_SCRIPT -update | Out-Null

    Write-SubStep "Addon Manager updated successfully" "success"
}
catch {
    Write-SubStep "Failed to update Addon Manager: $_" "warning"
}
...
Write-Step 8 8 "Applying Spicetify configuration..." "running"
