...
window.LANG_DE = {
  ...
  "settings": {
    ...
    "aiProviders": {
      ...
      "openaiConnections": "Weitere OpenAI-kompatible Anbieter",
      "openaiConnectionsDesc": "Wenn die primäre Verbindung fehlschlägt, werden die unten aktivierten Anbieter der Reihe nach versucht.",
      "addOpenaiConnection": "Benutzerdefinierten Anbieter hinzufügen",
      "connectionName": "Anbietername",
      "removeConnection": "Anbieter entfernen",
      "testThisConnection": "Diesen Anbieter testen",
      "connectionSuccess": "Verbindung erfolgreich.",
      "saveConnection": "Speichern",
      "sonarModelsFallback": "Sonar hat keine API für Modelllisten. Die integrierte Liste unterstützter Modelle wird angezeigt.",
      "pollinationsAllModels": "Zugriff auf alle Modelle wird angefordert. Wähle nach dem Verbinden ein Modell aus.",
      "model": "Modell",
      "modelId": "Modell ID",
      "baseUrl": "Basis URL",
      "apiKey": "API Schlüssel",
      "apiKeyDesc": "Unterstützt einen einzelnen Schlüssel, eine Zeilenumbruchliste oder ein JSON-Array. Nur auf diesem Gerät gespeichert.",
      "refreshModels": "Aktualisieren",
      ...
      "pollinationsConnect": "Bei Pollinations anmelden",
      "pollinationsReconnect": "Erneut verbinden",
      "pollinationsWaiting": "Auf Anmeldung warten",
      "pollinationsOpenLogin": "Anmeldeseite öffnen",
      "pollinationsDisconnect": "Verbindung trennen",
      "pollinationsDisconnected": "Pollinations-Konto · Deaktiviert",
      "pollinationsRequesting": "Bei Pollinations anmelden…",
      "pollinationsConnected": "Pollinations-Konto · Aktiviert",
      "pollinationsKeyConfigured": "Pollinations-Konto · Konfiguriert",
      "pollinationsKeyStatus": "Pollinations-Konto · Aktiviert: %s",
      "pollinationsDescription": "Unterstützt manuelle API-Schlüssel und Konto-Anmeldetokens. Ein vorhandenes Anmeldetoken wird bevorzugt.",
      "pollinationsInvalid": "Der API-Schlüssel ist ungültig. Verbinde dich erneut oder gib einen neuen Schlüssel ein.",
      "pollinationsExpires": "Läuft in %d Tag(en) ab"
    },
    "lyricsProviders": {
