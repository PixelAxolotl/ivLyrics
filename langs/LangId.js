...
window.LANG_ID = {
  ...
  "settings": {
    ...
    "aiProviders": {
      ...
      "openaiConnections": "Penyedia tambahan yang kompatibel dengan OpenAI",
      "openaiConnectionsDesc": "Jika koneksi utama gagal, penyedia aktif di bawah akan dicoba secara berurutan.",
      "addOpenaiConnection": "Tambah penyedia kustom",
      "connectionName": "Nama penyedia",
      "removeConnection": "Hapus penyedia",
      "testThisConnection": "Uji penyedia ini",
      "connectionSuccess": "Koneksi berhasil.",
      "saveConnection": "Simpan",
      "sonarModelsFallback": "Sonar tidak memiliki API daftar model. Daftar bawaan model yang didukung ditampilkan.",
      "pollinationsAllModels": "Akses ke semua model akan diminta. Pilih model setelah terhubung.",
      "model": "Model",
      "modelId": "Model ID",
      "baseUrl": "Basis URL",
      "apiKey": "API Kunci",
      "apiKeyDesc": "Mendukung satu kunci, daftar baris baru, atau array JSON. Hanya disimpan di perangkat ini.",
      "refreshModels": "Segarkan",
      ...
      "pollinationsAccount": "Akun Pollinations",
      "pollinationsConnect": "Masuk ke Pollinations",
      "pollinationsReconnect": "Hubungkan kembali",
      "pollinationsWaiting": "Menunggu proses masuk",
      "pollinationsOpenLogin": "Buka halaman masuk",
      "pollinationsDisconnect": "Putuskan koneksi",
      "pollinationsDisconnected": "Akun Pollinations · Nonaktif",
      "pollinationsRequesting": "Masuk ke Pollinations…",
      "pollinationsConnected": "Akun Pollinations · Aktif",
      "pollinationsKeyConfigured": "Akun Pollinations · Dikonfigurasi",
      "pollinationsKeyStatus": "Akun Pollinations · Aktif: %s",
      "pollinationsDescription": "Mendukung kunci API manual dan token masuk akun. Token masuk dipakai lebih dahulu jika tersedia.",
      "pollinationsInvalid": "Kunci API tidak valid. Hubungkan kembali atau masukkan kunci baru.",
      "pollinationsExpires": "Kedaluwarsa dalam %d hari"
    },
    "lyricsProviders": {
