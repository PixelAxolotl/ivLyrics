...
window.LANG_JA = {
  ...
  "syncCreator": {
    ...
    "splitHere": "ここで分割",
    "multiVocalMetaRequired": "現在のボーカルのSPEAKERとTYPEを先に選択してください。",
    ...
    "linePartMetaRequired": "{line}行目のすべてのボーカルパートにSPEAKERとTYPEを選択してください。",
    "lineMetaRequired": "{line}行目のSPEAKERとTYPEを選択してください。",
    "multiVocalBannerParts": "複数ボーカルモード: 各ボーカルパートを個別にシンクしてください。",
    "multiVocalBannerLine": "複数ボーカルモード: この行のSPEAKERとTYPEを選択してください。",
